...
export const COLLECTIONS_VIEWS = { _viewStoresList: '_viewStoresList', _viewSalesList: '_viewSalesList', _viewTermsAndConditionsList: '_viewTermsAndConditionsList', _viewCustomersList: '_viewCustomersList', _viewOsList: '_viewOsList', _viewPartsServicesProductsList: '_viewPartsServicesProductsList', _viewUsersList: '_viewUsersList' } as const
