...
const Modals = () => {
  ...
  return <div>
    ...
    <div className="  sm:px-6 lg:px-8 bg-[#F1F5F9] py-8">
      <div className=" sm:mx-auto sm:w-full sm:max-w-4xl">
        <div className="bg-white  shadow sm:mx4 sm:rounded-lg max-[639px]:mx-4 max-[380px]:mx-4 max-[380px]:rounded-lg px-4 py-2">
          ...
          <div className='grid grid-cols-3 gap-4 max-[380px]:grid-cols-1'>
          ...
          <div className='grid grid-cols-4 gap-4 max-[380px]:grid-cols-2'>
            <div className="  mt-4">
              <label htmlFor="text" className='text-sm mt-2'>
                CEP
              </label>
